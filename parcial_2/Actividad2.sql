--Camila Aseret Rodriguez Baldovino 4:J t/v aula 3 
...
FROM Empleados e
JOIN Empleados j ON e.id_gerente = j.id_empleado 
)
...
INSERT INTO Entregas (id_cliente,id_orden,estado_destino,costo) VALUES 
(1001, 1, 'JAL', '$987'),
(1001, 2, 'CDMX', '$400'),
(1001, 3, 'CDMX', '$545'),
(1001, 4, 'CDMX', '$321'),
...
AND id_cliente IN (
    SELECT id_cliente FROM Entregas WHERE estado_destino = 'JAL'
);